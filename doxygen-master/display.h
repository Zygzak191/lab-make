...
#define PREDEFINIOWANA_ZMIENNA 79 /**< Liczba. */
...
/** @brief Prosta funkcja
 * @details Prosta funkcja do zadania na 
 * Srodowiska i narzedzia wytwarzania oprogramowania
 * @param wartosc liczba do podniesienia do kwadratu
 * @return Kwadrat wartosci
 */
